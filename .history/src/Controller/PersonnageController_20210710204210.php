...
class PersonnageController extends AbstractController
{
    ...
    /**
     * @Route("/persos", name="lister_personnages")
     */
    ...
    public function afficherPerso($name): Response
    {
        ...
        $person = Personnage::getPersonnageParNom($name); 
        ...
        // Pour afficher juste le nom on a utilisé le {name} de la route et ça a suffit pour
        // le rendu "return $this->render('personnage/perso.html.twig', ["nammame" => $name
        // Mais maintenant on veut afficher toutes les infos du personnage. On a donc besoin
        // d'une fonction qui retourne $pers pour ce name spécifique
